...
*/
    ...
    @Override
    // xemu: gesture back navigation is handled by the app, silence the lint check
...
//        }
    ...
    public void onSystemUiVisibilityChange(int visibility) {
        // xemu: On Android 11+ (API 30+), WindowInsetsController handles system UI
        // hiding, so this legacy rehide loop is not needed and causes focus flicker.
